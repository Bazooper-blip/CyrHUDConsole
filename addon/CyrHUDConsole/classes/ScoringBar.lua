...
function bar:configureLabel(label)
    ...
    label:positionControl(TEXT_SCROLL_DC, 50, 40, 131, -4)
    label:positionControl(TEXT_SCROLL_EP, 50, 40, 226, -4)
    label:positionControl(TEXT_SCROLL_AD, 50, 40, 321, -4)
    ...
    label:positionControl(TEXT_TIME, 110, 40, 10, 10)
    label:positionControl(TEXT_DC, 50, 40, 145, 10)
    label:positionControl(TEXT_EP, 50, 40, 240, 10)
    label:positionControl(TEXT_AD, 50, 40, 335, 10)
    label:positionControl(SCROLL_DC, 32, 32, 118, -09)
    label:positionControl(SCROLL_EP, 32, 32, 213, -09)
    label:positionControl(SCROLL_AD, 32, 32, 308, -09)
    ...
    if CyrHUD.cfg.showPopBars then
        ...
        label:positionControl(ICON_DC, 28, 28, 117, 7)
        label:positionControl(ICON_EP, 28, 28, 212, 7)
        label:positionControl(ICON_AD, 28, 28, 307, 7)
    else
        ...
        label:positionControl(ICON_DC, 30, 30, 120, 10)
        label:positionControl(ICON_EP, 30, 30, 215, 10)
        label:positionControl(ICON_AD, 30, 30, 310, 10)
    end
end
