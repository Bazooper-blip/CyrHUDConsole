...
function bar:configureLabel(label)
    ...
    label:positionControl(TEXT_SCROLL_DC, 50, 40, 111, -4)
    label:positionControl(TEXT_SCROLL_EP, 50, 40, 206, -4)
    label:positionControl(TEXT_SCROLL_AD, 50, 40, 301, -4)
    ...
    label:positionControl(TEXT_DC, 50, 40, 125, 10)
    label:positionControl(TEXT_EP, 50, 40, 220, 10)
    label:positionControl(TEXT_AD, 50, 40, 315, 10)
    label:positionControl(SCROLL_DC, 32, 32,  98, -09)
    label:positionControl(SCROLL_EP, 32, 32, 193, -09)
    label:positionControl(SCROLL_AD, 32, 32, 288, -09)
    ...
    if CyrHUD.cfg.showPopBars then
        ...
        label:positionControl(ICON_DC, 28, 28,  97, 7)
        label:positionControl(ICON_EP, 28, 28, 192, 7)
        label:positionControl(ICON_AD, 28, 28, 287, 7)
    else
        ...
        label:positionControl(ICON_DC, 30, 30, 100, 10)
        label:positionControl(ICON_EP, 30, 30, 195, 10)
        label:positionControl(ICON_AD, 30, 30, 290, 10)
    end
end
